...
pub fn get_migrations() -> Vec<Migration> {
    ...
    Migration {
        version: 5,
        description: "ssh_profiles_and_known_hosts",
        sql: "
    ...
    Migration {
        version: 6,
        description: "ssh_tunnel_support_for_db_connections",
        // NULL = no tunnel = legacy behaviour. We don't add a FK constraint
        // because SQLite ALTER TABLE can't add one cleanly; referential
        // integrity is enforced at the application layer (the runtime treats
        // a missing profile as a connect-time error).
        sql: "
